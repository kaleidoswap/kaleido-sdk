...
class ChannelDetails(BaseModel):
    ...
    temporary_channel_id: Optional[str] = Field(None, title="Temporary Channel Id")
    funded_at: Optional[AwareDatetime] = Field(None, title="Funded At")
    funding_outpoint: Optional[str] = Field(None, title="Funding Outpoint")
    expires_at: Optional[AwareDatetime] = Field(None, title="Expires At")
...
class ChannelFees(BaseModel):
    ...
    applied_discount: Optional[float] = Field(None, title="Applied Discount")
    discount_code: Optional[str] = Field(None, title="Discount Code")
...
class CreateOrderRequest(BaseModel):
    ...
    refund_onchain_address: Optional[str] = Field(None, title="Refund Onchain Address")
    announce_channel: bool = Field(True, title="Announce Channel")
    asset_id: Optional[str] = Field(None, title="Asset Id")
    lsp_asset_amount: Optional[int] = Field(None, title="Lsp Asset Amount")
    client_asset_amount: Optional[int] = Field(None, title="Client Asset Amount")
    rfq_id: Optional[str] = Field(None, title="Rfq Id")
...
class RateDecisionResponse(BaseModel):
    ...
    refund_txid: Optional[str] = Field(None, title="Refund Txid")
...
class RouteStep(BaseModel):
    ...
    indicative_price: Optional[str] = Field(
        None,
...
class FromLayer(RootModel[Layer]):
    """
...
class SwapNodeInfoResponse(BaseModel):
    ...
    network: Optional[str] = Field(..., examples=["Signet"], title="Network")
    block_height: Optional[int] = Field(..., examples=[805434], title="Block Height")
...
class Asset(BaseModel):
    ...
    supported_layers: Optional[list[str]] = Field(
        None,
...
class PaymentOnchain(BaseModel):
    ...
    refund_onchain_address: Optional[str] = Field(None, title="Refund Onchain Address")
    payment_status: Optional[str] = Field(None, title="Payment Status")
    ...
    last_payment_check: Optional[int] = Field(None, title="Last Payment Check")
...
class Swap(BaseModel):
    ...
    initiated_at: Optional[int] = Field(
        None, examples=[1691168512], title="Initiated At"
    )
    expires_at: int = Field(..., examples=[1691172703], title="Expires At")
    completed_at: Optional[int] = Field(
        None, examples=[1691171075], title="Completed At"
    )
...
class SwapOrder(BaseModel):
    ...
    maker_pubkey: Optional[str] = Field(
    ...
    deposit_address: Optional[ReceiverAddress] = Field(
        None, description="Address/Invoice for the user to deposit funds into"
    )
    payout_address: Optional[ReceiverAddress] = Field(
        None,
...
class TradingPair(BaseModel):
    ...
    routes: Optional[list[SwapRoute]] = Field(None, title="Routes")
...
class CreateSwapOrderRequest(BaseModel):
    ...
    min_onchain_conf: Optional[int] = Field(1, title="Min Onchain Conf")
    refund_address: Optional[str] = Field(None, title="Refund Address")
...
class CreateSwapOrderResponse(BaseModel):
    ...
    deposit_address: Optional[ReceiverAddress] = None
    status: SwapOrderStatus
...
class ChannelOrderResponse(BaseModel):
    ...
    channel: Optional[ChannelDetails] = None
    asset_id: Optional[str] = Field(None, title="Asset Id")
    lsp_asset_amount: Optional[int] = Field(None, title="Lsp Asset Amount")
    client_asset_amount: Optional[int] = Field(None, title="Client Asset Amount")
    rfq_id: Optional[str] = Field(None, title="Rfq Id")
    asset_price_sat: Optional[int] = Field(None, title="Asset Price Sat")
    asset_delivery_status: Optional[AssetDeliveryStatus] = None
    asset_delivery_payment_hash: Optional[str] = Field(
        None, title="Asset Delivery Payment Hash"
    )
    asset_delivery_completed_at: Optional[AwareDatetime] = Field(
        None, title="Asset Delivery Completed At"
    )
    asset_delivery_error: Optional[str] = Field(None, title="Asset Delivery Error")
