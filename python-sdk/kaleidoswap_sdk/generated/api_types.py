...
#   filename:  maker.json
#   timestamp: 2026-01-22T02:03:45+00:00
...
class RoutesRequest(BaseModel):
    ...
    from_layer: FromLayer | None = Field(None, description="Filter by source layer (optional)")
    to_asset: str | None = Field(
        None,
        description="Destination asset (if None, returns all reachable assets)",
        title="To Asset",
    )
    to_layer: ToLayer | None = Field(None, description="Filter by destination layer (optional)")
    max_hops: int = Field(
