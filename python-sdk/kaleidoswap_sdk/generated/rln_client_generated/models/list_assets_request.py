...
class ListAssetsRequest:
    """
    Attributes:
        filter_asset_schemas (Union[Unset, list[AssetSchema]]):
    """

    filter_asset_schemas: Unset | list[AssetSchema] = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        filter_asset_schemas: Unset | list[str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for filter_asset_schemas_item_data in _filter_asset_schemas or []:
