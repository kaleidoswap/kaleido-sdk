...
class BtcBalanceResponse:
    """
    Attributes:
        vanilla (Union[Unset, BtcBalance]):
        colored (Union[Unset, BtcBalance]):
    """

    vanilla: Union[Unset, "BtcBalance"] = UNSET
    colored: Union[Unset, "BtcBalance"] = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        vanilla: Unset | dict[str, Any] = UNSET
        if not isinstance(self.vanilla, Unset):
            vanilla = self.vanilla.to_dict()

        colored: Unset | dict[str, Any] = UNSET
