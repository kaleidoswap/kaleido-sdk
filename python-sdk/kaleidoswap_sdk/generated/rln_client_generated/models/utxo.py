...
class Utxo:
    """
    Attributes:
        outpoint (Union[Unset, str]):
        btc_amount (Union[Unset, int]):
        colorable (Union[Unset, bool]):
    """

    outpoint: Unset | str = UNSET
    btc_amount: Unset | int = UNSET
    colorable: Unset | bool = UNSET
