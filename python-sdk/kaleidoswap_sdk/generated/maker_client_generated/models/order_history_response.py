...
if TYPE_CHECKING:
    from ..models.order_history_summary import OrderHistorySummary
...
class OrderHistoryResponse:
    """
    Attributes:
        data (list['OrderHistorySummary']): List of orders
        pagination (PaginationMeta): Pagination metadata
    """

    data: list["OrderHistorySummary"]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = OrderHistorySummary.from_dict(data_item_data)
