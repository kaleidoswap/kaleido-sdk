...
) -> HTTPValidationError | OrderStatsResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | OrderStatsResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[HTTPValidationError, OrderStatsResponse]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, OrderStatsResponse]
    """
