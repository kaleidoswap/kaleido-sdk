...
from ...models.channel_fees import ChannelFees
...
) -> ChannelFees | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = ChannelFees.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChannelFees | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ChannelFees, HTTPValidationError]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[ChannelFees, HTTPValidationError]
    """
