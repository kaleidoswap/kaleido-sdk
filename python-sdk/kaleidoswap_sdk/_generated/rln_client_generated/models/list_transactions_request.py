...
T = TypeVar("T", bound="ListTransactionsRequest")
...
class ListTransactionsRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_transactions_request = cls(
            skip_sync=skip_sync,
        )

        list_transactions_request.additional_properties = d
        return list_transactions_request
