...
class IssueAssetUDARequest:
    ...
    Attributes:
        ...
        media_file_digest (Union[Unset, str]):
        attachments_file_digests (Union[Unset, list[str]]):
    """
    ...
    media_file_digest: Unset | str = UNSET
    attachments_file_digests: Unset | list[str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attachments_file_digests = cast(list[str], d.pop("attachments_file_digests", UNSET))
