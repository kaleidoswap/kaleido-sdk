...
class DecodeRGBInvoiceResponse:
    ...
    Attributes:
        ...
        recipient_type (Union[Unset, RecipientType]):
        asset_schema (Union[Unset, AssetSchema]):
        asset_id (Union[Unset, str]):
        assignment (Union['AssignmentAny', 'AssignmentFungible', 'AssignmentInflationRight', 'AssignmentNonFungible',
    ...
    recipient_type: Unset | RecipientType = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        recipient_type: Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recipient_type: Unset | RecipientType
        ...
        def _parse_assignment(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_assignment_type_1 = AssignmentNonFungible.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_assignment_type_2 = AssignmentInflationRight.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_assignment_type_3 = AssignmentReplaceRight.from_dict(data)
