...
class AssetsOptions:
    """
    Attributes:
        name (Union[Unset, str]):  Default: 'US Dollar Notes'.
        asset_id (Union[None, Unset, str]):  Default: 'rgb:$i4cFKwt-2C5LZ3X-l$kOTGN-O6l1AOP-aP9COyn-7IeBkEM'.
        ticker (Union[Unset, str]):  Default: 'USDT'.
        precision (Union[Unset, int]):  Default: 6.
        issued_supply (Union[Unset, int]):  Default: 0.
        min_initial_client_amount (Union[Unset, int]):  Default: 0.
        max_initial_client_amount (Union[Unset, int]):  Default: 0.
        min_initial_lsp_amount (Union[Unset, int]):  Default: 0.
        max_initial_lsp_amount (Union[Unset, int]):  Default: 10000.
        min_channel_amount (Union[Unset, int]):  Default: 0.
        max_channel_amount (Union[Unset, int]):  Default: 10000.
    """

    name: Unset | str = "US Dollar Notes"
    asset_id: None | Unset | str = "rgb:$i4cFKwt-2C5LZ3X-l$kOTGN-O6l1AOP-aP9COyn-7IeBkEM"
    ticker: Unset | str = "USDT"
    precision: Unset | int = 6
    issued_supply: Unset | int = 0
    min_initial_client_amount: Unset | int = 0
    max_initial_client_amount: Unset | int = 0
    min_initial_lsp_amount: Unset | int = 0
    max_initial_lsp_amount: Unset | int = 10000
    min_channel_amount: Unset | int = 0
    max_channel_amount: Unset | int = 10000
