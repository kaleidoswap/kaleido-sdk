...
class ChannelDetails:
    ...
    Attributes:
        ...
        temporary_channel_id (Union[None, Unset, str]):
        funded_at (Union[None, Unset, datetime.datetime]):
        funding_outpoint (Union[None, Unset, str]):
        expires_at (Union[None, Unset, datetime.datetime]):
    """

    channel_id: None | Unset | str = UNSET
    temporary_channel_id: None | Unset | str = UNSET
    funded_at: None | Unset | datetime.datetime = UNSET
    funding_outpoint: None | Unset | str = UNSET
    expires_at: None | Unset | datetime.datetime = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        channel_id: None | Unset | str
        if isinstance(self.channel_id, Unset):
            channel_id = UNSET
        else:
            channel_id = self.channel_id

        temporary_channel_id: None | Unset | str
        if isinstance(self.temporary_channel_id, Unset):
            temporary_channel_id = UNSET
        else:
            temporary_channel_id = self.temporary_channel_id

        funded_at: None | Unset | str
        ...
        funding_outpoint: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_channel_id(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        def _parse_temporary_channel_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        temporary_channel_id = _parse_temporary_channel_id(d.pop("temporary_channel_id", UNSET))

        def _parse_funded_at(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_funding_outpoint(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
