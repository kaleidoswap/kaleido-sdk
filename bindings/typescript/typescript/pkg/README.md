...
```bash
npm install @kaleidoswap/sdk-web
# or
yarn add @kaleidoswap/sdk-web
# or
pnpm add @kaleidoswap/sdk-web
```
...
```typescript
import { toSmallestUnits, toDisplayUnits } from '@kaleidoswap/sdk-web';
...
```typescript
import type { Asset, TradingPair, Quote } from '@kaleidoswap/sdk-web';
```
