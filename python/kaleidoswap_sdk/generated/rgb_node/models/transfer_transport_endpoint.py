...
class TransferTransportEndpoint:
    """
    Attributes:
        endpoint (str | Unset):  Example: http://127.0.0.1:3000/json-rpc.
        transport_type (TransportType | Unset):
        used (bool | Unset):
    """

    endpoint: str | Unset = UNSET
    transport_type: TransportType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        transport_type: str | Unset = UNSET
