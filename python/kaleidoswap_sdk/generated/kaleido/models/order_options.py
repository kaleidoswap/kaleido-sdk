...
class OrderOptions:
    """
    Attributes:
        min_required_channel_confirmations (int | Unset):  Default: 0.
        min_funding_confirms_within_blocks (int | Unset):  Default: 0.
        min_onchain_payment_confirmations (int | None | Unset):
        supports_zero_channel_reserve (bool | Unset):  Default: True.
        min_onchain_payment_size_sat (int | None | Unset):
        max_channel_expiry_blocks (int | Unset):  Default: 20160.
        min_initial_client_balance_sat (int | Unset):  Default: 0.
        max_initial_client_balance_sat (int | Unset):  Default: 1000000.
        min_initial_lsp_balance_sat (int | Unset):  Default: 0.
        max_initial_lsp_balance_sat (int | Unset):  Default: 16777215.
        min_channel_balance_sat (int | Unset):  Default: 50000.
        max_channel_balance_sat (int | Unset):  Default: 16777215.
    """

    min_required_channel_confirmations: int | Unset = 0
    min_funding_confirms_within_blocks: int | Unset = 0
    min_onchain_payment_confirmations: int | None | Unset = UNSET
    supports_zero_channel_reserve: bool | Unset = True
    min_onchain_payment_size_sat: int | None | Unset = UNSET
    max_channel_expiry_blocks: int | Unset = 20160
    min_initial_client_balance_sat: int | Unset = 0
    max_initial_client_balance_sat: int | Unset = 1000000
    min_initial_lsp_balance_sat: int | Unset = 0
    max_initial_lsp_balance_sat: int | Unset = 16777215
    min_channel_balance_sat: int | Unset = 50000
    max_channel_balance_sat: int | Unset = 16777215
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if min_initial_client_balance_sat is not UNSET:
            field_dict["min_initial_client_balance_sat"] = (
                min_initial_client_balance_sat
            )
        if max_initial_client_balance_sat is not UNSET:
            field_dict["max_initial_client_balance_sat"] = (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        min_required_channel_confirmations = d.pop(
            "min_required_channel_confirmations", UNSET
        )

        min_funding_confirms_within_blocks = d.pop(
            "min_funding_confirms_within_blocks", UNSET
        )

        def _parse_min_onchain_payment_confirmations(
            data: object,
        ) -> int | None | Unset:
            if data is None:
                return data
        ...
        def _parse_min_onchain_payment_size_sat(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
