...
if TYPE_CHECKING:
    from ..models.order_stats_response_status_counts import (
...
class OrderStatsResponse:
    """
    Attributes:
        status_counts (OrderStatsResponseStatusCounts): Count of orders by status
        filled_orders_volume (int): Total volume of filled orders
        filled_orders_count (int): Total count of filled orders
    """

    status_counts: OrderStatsResponseStatusCounts
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        status_counts = OrderStatsResponseStatusCounts.from_dict(d.pop("status_counts"))
