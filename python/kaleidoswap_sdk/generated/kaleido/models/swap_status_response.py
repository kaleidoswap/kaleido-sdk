...
class SwapStatusResponse:
    """
    Attributes:
        swap (None | Swap | Unset):
    """

    swap: None | Swap | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_swap(data: object) -> None | Swap | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                swap_type_0 = Swap.from_dict(data)

                return swap_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Swap | Unset, data)
