// src/user/index.ts
import { nip05, nip19 as nip194 } from "nostr-tools";
...
// src/events/index.ts
var NDKEvent = class extends EventEmitter4 {
  ndk;
  created_at;
  content = "";
  tags = [];
...
var NDKUser = class {
  ...
  get npub() {
    if (!this._npub) {
      ...
      this._npub = nip194.npubEncode(this.hexpubkey);
    }
    return this._npub;
  }
  set npub(npub) {
  ...
  get hexpubkey() {
    if (!this._hexpubkey) {
      ...
      this._hexpubkey = nip194.decode(this.npub).data;
    }
  ...
  async validateNip05(nip05Id) {
    if (!this.ndk)
      throw new Error("No NDK instance found");
    const profilePointer = await nip05.queryProfile(nip05Id);
...
var NDK = class extends EventEmitter9 {
  explicitRelayUrls;
  pool;
  outboxPool;
  signer;
