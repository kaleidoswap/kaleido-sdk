...
pub struct Transfer {
    ...
    pub requested_assignment: Option<Box<models::AssignmentFungible>>,
    #[serde(rename = "assignments", skip_serializing_if = "Option::is_none")]
    pub assignments: Option<Vec<models::AssignmentFungible>>,
    #[serde(rename = "kind", skip_serializing_if = "Option::is_none")]
    pub kind: Option<models::TransferKind>,
    ...
    pub transport_endpoints: Option<Vec<models::TransferTransportEndpoint>>,
}
