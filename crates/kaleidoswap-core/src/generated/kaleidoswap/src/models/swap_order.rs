...
pub struct SwapOrder {
    ...
    pub status: Option<models::SwapOrderStatus>,
    ...
    #[serde(rename = "fee")]
    pub fee: Box<models::Fee>,
}

impl SwapOrder {
    pub fn new(id: String, rfq_id: String, from_asset: models::SwapLeg, to_asset: models::SwapLeg, price: i32, fee: models::Fee) -> SwapOrder {
        SwapOrder {
            id,
            rfq_id,
            maker_pubkey: None,
