...
pub struct ChannelOrderResponse {
    ...
    pub order_state: models::OrderState,
    #[serde(rename = "payment")]
    pub payment: Box<models::PaymentDetails>,
    #[serde(rename = "channel", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub channel: Option<Option<Box<models::ChannelDetails>>>,
    ...
    pub asset_delivery_status: Option<Option<models::AssetDeliveryStatus>>,
    ...
    #[serde(rename = "asset_delivery_completed_at", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub asset_delivery_completed_at: Option<Option<String>>,
    #[serde(rename = "asset_delivery_error", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl ChannelOrderResponse {
    pub fn new(order_id: String, client_pubkey: String, lsp_balance_sat: i32, client_balance_sat: i32, required_channel_confirmations: i32, funding_confirms_within_blocks: i32, channel_expiry_blocks: i32, announce_channel: bool, order_state: models::OrderState, payment: models::PaymentDetails) -> ChannelOrderResponse {
