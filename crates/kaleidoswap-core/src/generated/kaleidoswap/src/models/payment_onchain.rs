...
pub struct PaymentOnchain {
    #[serde(rename = "state")]
    pub state: models::PaymentState,
    #[serde(rename = "expires_at")]
    pub expires_at: String,
    #[serde(rename = "fee_total_sat")]
    pub fee_total_sat: i32,
    #[serde(rename = "order_total_sat")]
    pub order_total_sat: i32,
    #[serde(rename = "address")]
    pub address: String,
    #[serde(rename = "min_fee_for_0conf")]
    pub min_fee_for_0conf: i32,
...
impl PaymentOnchain {
    pub fn new(state: models::PaymentState, expires_at: String, fee_total_sat: i32, order_total_sat: i32, address: String, min_fee_for_0conf: i32, min_onchain_payment_confirmations: i32) -> PaymentOnchain {
        PaymentOnchain {
            state,
            expires_at,
            fee_total_sat,
