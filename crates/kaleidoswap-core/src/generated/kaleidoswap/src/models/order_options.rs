...
pub struct OrderOptions {
    ...
    pub min_onchain_payment_size_sat: Option<Option<i32>>,
    ...
    pub min_initial_client_balance_sat: Option<i32>,
    #[serde(rename = "max_initial_client_balance_sat", skip_serializing_if = "Option::is_none")]
    pub max_initial_client_balance_sat: Option<i32>,
    #[serde(rename = "min_initial_lsp_balance_sat", skip_serializing_if = "Option::is_none")]
    pub min_initial_lsp_balance_sat: Option<i32>,
    #[serde(rename = "max_initial_lsp_balance_sat", skip_serializing_if = "Option::is_none")]
    pub max_initial_lsp_balance_sat: Option<i32>,
    #[serde(rename = "min_channel_balance_sat", skip_serializing_if = "Option::is_none")]
    pub min_channel_balance_sat: Option<i32>,
    #[serde(rename = "max_channel_balance_sat", skip_serializing_if = "Option::is_none")]
    pub max_channel_balance_sat: Option<i32>,
}
