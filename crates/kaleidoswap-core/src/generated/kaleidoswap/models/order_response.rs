...
impl OrderResponse {
    pub fn new(order_id: String, client_pubkey: String, lsp_balance_sat: i64, client_balance_sat: i64, required_channel_confirmations: i32, funding_confirms_within_blocks: i32, channel_expiry_blocks: i32, announce_channel: bool, order_state: OrderState, payment: PaymentDetails) -> OrderResponse {
        OrderResponse {
            order_id,
            client_pubkey,
            lsp_balance_sat,
