...
impl CreateOrderRequest {
    pub fn new(client_pubkey: String, lsp_balance_sat: i64, client_balance_sat: i64, required_channel_confirmations: i32, funding_confirms_within_blocks: i32, channel_expiry_blocks: i32) -> CreateOrderRequest {
        CreateOrderRequest {
            client_pubkey,
            lsp_balance_sat,
            client_balance_sat,
