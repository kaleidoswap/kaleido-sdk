...
impl PaymentOnchain {
    pub fn new(state: PaymentState, expires_at: String, fee_total_sat: i32, order_total_sat: i32, address: String, min_fee_for_0conf: i32, min_onchain_payment_confirmations: i32) -> PaymentOnchain {
        PaymentOnchain {
            state,
            expires_at,
            fee_total_sat,
