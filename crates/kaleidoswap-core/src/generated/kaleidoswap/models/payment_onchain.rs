...
impl PaymentOnchain {
    pub fn new(state: PaymentState, expires_at: String, fee_total_sat: i64, order_total_sat: i64, address: String, min_fee_for_0conf: i64, min_onchain_payment_confirmations: i64) -> PaymentOnchain {
        PaymentOnchain {
            state,
            expires_at,
            fee_total_sat,
