...
describe('MakerClient Integration', () => {
    ...
    describe('Market Data', () => {
        it('should list assets', { timeout: 10000 }, async () => {
            try {
        ...
        it('should list trading pairs', { timeout: 10000 }, async () => {
            try {
    ...
    describe('Quote Operations', () => {
        it('should get quote by pair', { timeout: 10000 }, async () => {
            try {
    ...
    describe('Pair Routes', () => {
        it('should get routes for a pair by ticker', { timeout: 10000 }, async () => {
            try {
        ...
        it('should discover market routes', { timeout: 10000 }, async () => {
            try {
    ...
    describe('Atomic Swap Operations', () => {
        it('should get swap node info', { timeout: 10000 }, async () => {
            try {
        ...
        it('should init a swap', { timeout: 15000 }, async () => {
            try {
        ...
        it('should get atomic swap status', { timeout: 15000 }, async () => {
            try {
                const quoteResponse = await client.maker.getQuote({
                    from_asset: { asset_id: 'BTC', layer: 'BTC_LN', amount: 4100000 },
                    to_asset: { asset_id: 'USDT', layer: 'RGB_LN', amount: null },
    ...
    describe('LSP Operations', () => {
        ...
        it('should get LSP network info', { timeout: 10000 }, async () => {
            try {
